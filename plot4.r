...
# Tell R there are 4 plots  in a 2x2 matrix layout
par(mfrow=c(2,2))

plot(dateRange$DateTime,dateRange$Global_active_power,type="l",
     xlab="",ylab="Global Active Power (kilowatts)")

plot(dateRange$DateTime,dateRange$Voltage,type="l",
...
legend("topright",c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty=c(1,1,1),col=c("black","red","blue"),bty="n",cex=0.7)

plot(dateRange$DateTime,dateRange$Global_reactive_power,type="l",
